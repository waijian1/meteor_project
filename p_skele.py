            ...
            if CFG.dynamic_rotation_enabled:
                ...
                if elapsed_time < CFG.dynamic_rotation_short_phase_duration:
                    ...
                    if p3:
                        ...
                        self._arrive_and_cast('P3')
                        print("[ROTATION] P3 cast complete. Returning to P1.")
                    # Return to P1 via P3_POST_TP safe spot if configured.
                    # Walk (no TP) to the safe post-P3 spot first, then LEFT+TP toward P1.
